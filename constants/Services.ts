export const services = [
  {
    ...
    description: 'Get a unique brand identity that makes you recognizable even from the moon. Become unique, stand out, get recognized!',
  ...
  },
  {
    ...
    description: 'Brings stories to life. Tell the untold stories about your brand. Craft sales fertilizing commercials and reach a wider audience.',
    image: '/Assets/image(1).svg',
  },
  {
    title: 'Sales Funnel Development',
    description: 'Increase customer retention through a unique funnel system designed specifically for your business type.',
